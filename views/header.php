...
<head>
    ...
    <link rel="stylesheet" href="http://webtotuenti.tech/twitter/styles.css">
    <title>Twitter</title>
</head>
...
<!-- NAVBAR -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand" href="http://webtotuenti.tech/twitter/index.php">Twitter</a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                <li class="nav-item">
                    <a class="nav-link" href="?page=timeline">Tu Linea de Tiempo</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?page=yourtweets">Tus Tweets</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="?page=publicprofiles">Perfiles publicos</a>
                </li>
            </ul>
